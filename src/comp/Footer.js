            ...
            <div className="flex items-center flex-wrap text-gray-600">
                ...
                <ul className="md:flex-1 mx-auto pt-8 text-center px-4 h-auto block">
                    ...
                    <li className="list-none pt-2 text-sm">
                        ...
                        <a href="https://facebook.com" className="hover:text-blue-300 italic" target="_blank">
                            Facebook
                        </a>
                    </li>
                    <li className="list-none pt-2 text-sm">
                        <span> <FontAwesomeIcon icon={faInstagram} size='1x' /> </span>
                        <a href="https://instagram.com" className="hover:text-blue-300 italic" target="_blank">
                            Instagram
                        </a>
                    </li>
                    <li className="list-none pt-2 text-sm">
                        ...
                        <a href="https://twitter.com" className="hover:text-blue-300 italic" target="_blank">
                            Twitter
                        </a>
                    </li>
                </ul>
